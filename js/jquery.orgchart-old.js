            ...
            that.addSiblings($edge.parent(), data.siblings ? data.siblings : data);
                           ...
                           setTimeout(function(){
                             ...
                             $( ".node" ).each(function()
                             {
                               ...
                               if(cargo.length > 22)
                               {
                               var res1 = cargo.substring(0, 21)+"-";
                               var res2 = "</div><div style='height:14px;font-size: 14px;color: rgba(0, 0, 0, 0.6)'>"+ toTitleCase(cargo.substring(21, cargo.length))+"</div>"
                               ...
                               {}
                                ...
                                var nombreDef= toTitleCase(nombre[0]+" "+nombre[2]);
                               ...
                               if (datos[2] === "true")
                               {
                                 ...
                                 $(this).addClass( "ghost" );
                                  ...
                                  +'<div class="node node2" data-id="'+datos[5]+'" style="float: right;"><div class="content" style="height: 100%;border-radius: 13px;background: #fffcfc;border: 2px dashed #c59d4c;">'
                                  +'<div class="divSup infoContent" style="background:#aaa" data-json="'+datos[4]+'" data-img="'+datos[1]+'" data-name="'+datos[0]+'" data-cargo="'+cargo+'">'
                                  +'<img src="img/'+datos[1]+'" alt="" height=61 width=65 class="img">'
                                  +'</div>'
                                  +'<div class="divInfer">'
                                  +'<div class="" style="height: 39%;"></div>'
                                  +'<div class="" style="height: 65%;">'
                                  +'<div style="height: 14px;"><spam class="name">'+nombreDef+'</spam></div><div style="height:14px" class="name">'+res+'</div>'
                               ...
                               else
                               {
                                 ...
                                 if (datos[3] != "")
                                {
                                  ...
                                  +'<div class="divSup infoContent" data-json="'+datos[4]+'" data-img="'+datos[1]+'" data-name="'+datos[0]+'" data-cargo="'+cargo+'">'
                                  +'<img src="img/'+datos[1]+'" alt=""  height=61 width=65 class="img">'
                                  +'</div>'
                                  +'<div class="divInfer">'
                                  +'<div class="" style="height: 39%;"></div>'
                                                                          ...
                                                                          $.ajax(
                                                                            {
                                                                              ...
                                                                              success: function(result)
                                                                              {
                                                                                ...
                                                                                for (var i = 0; i < result.length; i++)
                                                                                {
                                                                                  ...
                                                                                  if($("#"+result[0].superior).hasClass("transversal"))
                                                                                  {}
                                                                                  else {
                                                                                    var nombre = datos[0].split(" ");
                                                                                  ...
                                                                                  +'<div style="width:50%;background: #ffffff;display: flex;border-right: 3px solid #aaaaaa;">'
                                                                                  +'<div style="width: 90%;">'
                                                                                  +'<div id="'+result[i].id+'" class="node node2" data-id="'+result[i].id+'" style="float: right;">'
                                                                                  +'<div class="content">'
                                                                                  +'<div class="divSup infoContent" data-json="TMASI" data-img="abatar.png" data-name="'+datos[0]+'" data-cargo="'+result[0].title+'">'
                                                                                  +'<img src="img/abatar.png" alt="" height="61" width="65" class="img">'
                                                                                  +'</div>'
                                                                                  +'<div class="divInfer">'
                                                                                  ...
                                                                                  +'</div></div></div><div style="width:50%;background: white;border-left: 3px solid #aaaaaa;">'
                                                                                  +'<br><br><br><br></div> </div>';
                                                                                  $("#"+result[0].superior).parent().append(html);
                                                                                  $("#"+result[0].superior).addClass("transversal");
                                                                                  ...
                                                                                  $(".node2").children().removeClass('transition');
                                                                                   ...
                                                                                   $(".tablaLogros").empty();
                                                                                   $(".tablaLogros").append('<thead><tr class="tr">	<td class="td">	Meses 	</td><td class="td">	 Meta 	      </td><td class="td">	 Logrado 	    </td><td class="td">	Ratio	  </td>	</tr></thead>');
                                                                                   ...
                                                                                   $.ajax(
                                                                                     {
                                                                                       ...
                                                                                       success: function(result)
                                                                                       {
                                                                                         ...
                                                                                         for (var i = 0; i < result.logros.length; i++)
                                                                                         {
                                                                                           ...
                                                                                           if (result.logros[i].COLOR=="ROJO") {color="red"}
                                                                                           else if (result.logros[i].COLOR=="VERDE") {color  = "green"}
                                                                                           else{color= "yellow" }




                                                                                          var html = '<tr class="tr">	<td class="td">'+result.logros[i].FECHA+'</td><td class="td tdRight">'+meta[0]+'</td><td class="td tdRight">'+logro[0]+'</td><td class="td tdRight" style="color:'+color+'">'+result.logros[i].RATIO+'%</td></tr>'
                                                                                         ...
                                                                                         var htmlPromedio = '<tr class="tr">	<td class="td"></td><td class="td tdRight"></td><td class="td tdRight"><strong>Promedio:</strong></td><td class="td tdRight" style="color:#000000e0"><strong>'+promedioLogrado.toFixed(2)+'%</strong></td></tr>'
                                                                                       ...
                                                                                       else
                                                                                       {
                                                                                         ...
                                                                                         if (result.salario != null)
                                                                                         {
                                                                                           ...
                                                                                           $(".tablaSalario").append('<thead><tr class= "tr">	<td class="td">	 Meses 	 </td><td class="td">Slario Variable(SV)</td><td class="td">Salario Fijo(SF)</td><td class="td"> Salario Total(ST)</td><td class="td"> 	 Aguinaldo </td><td class="td"> 	 Aporte Patronal Y Obrero 25,5%</td></tr></thead>');
                                                                                         ...
                                                                                         for (var i = 0; i < result.salario.length; i++)
                                                                                         {
                                                                                          ...
                                                                                          var html = '<tr class="tr">	<td class="td">'+result.salario[i].PERIODO+'</td><td class="td tdRight">'+VARIABLE+'</td><td class="td tdRight">'+FIJO+'</td><td class="td tdRight">'+TOTAL+'</td><td class="td tdRight">-</td><td class="td tdRight">-</td></tr>';
                                                                                         ...
                                                                                         total = total.toFixed(0);
                                                                                          ...
                                                                                          $(".tablaSalario").append('<tr class="tr">	<td class="td">	Promedios:</td><td class="td tdRight"> 	<strong>'+variable+'</strong></td><td class="td tdRight"> <strong>'+fijo+'</strong>	 	 </td><td class="td tdRight"> <strong>'+total+'</strong>	 	 </td><td class="td tdRight">  <strong>-</strong>	 	 </td><td class="td tdRight">  <strong>-</strong>		 </td> 	 </tr>');
                                                                                        }
                                                                                        else {
                                                                                           $(".tablaSalario").empty();
                                                                                        }
                                                                                   ...
                                                                                   $("#nombre").html(nombre[0]);
                                                                                   $("#infoCargo").html(cargo);
                                                                                   $(".imgProfile").attr("style","height: 63%;background-image: url(img/"+img+");background-color: #cccccc;background-repeat:no-repeat;background-size: 100% 115%;height: 101px;width:110px;border: 3px solid #c59d4c;border-radius: 17px;");
                                                                                   $(".divInfo").hide();
                                                                                   $("#"+jsonInfo).show();
    ...
    bottomEdgeClickHandler: function (event)
    {
         ...
         if (childrenState.exist) {
          ...
          { // show the descendants
             ...
             $("#divTransversal"+$node[0].id).fadeIn();
           }
