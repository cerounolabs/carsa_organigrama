...
<div class="login-form">
    <form action="/examples/actions/confirmation.php" method="post">
    	...
    	<h4 class="modal-title">Ingrese Su Cuenta</h4>
        ...
        <input type="button" class="btn btn-primary btn-block btn-lg btnLogin" value="Login">
    </form>
    <div style="display:none" class="text-center small">Don't have an account? <a href="#">Sign up</a></div>
</div>
